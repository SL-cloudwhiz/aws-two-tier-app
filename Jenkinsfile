    ...
    stages {
        ...
        stage('Git Checkout') {
            steps {
                git branch: 'main',
                    ...
                    url: 'https://github.com/SL-cloudwhiz/aws-2-tier-project.git'
            }
        }
        ...
        stage('Clone Helm Chart for CD') {
            steps {
                git branch: 'main',
                    credentialsId: 'github-cred',
                    url: 'https://github.com/SL-cloudwhiz/aws-2-tier-helm-chart.git'
            }
        }
            ...
            steps {
                withCredentials([usernamePassword(
                    ...
                    sh """
                        ...
                        sed -i "s|image: <YOUR_ACCOUNT_ID>.dkr.ecr.us-east-1.amazonaws.com/frontend-repo:.*|image: <YOUR_ACCOUNT_ID>.dkr.ecr.us-east-1.amazonaws.com/frontend-repo:${IMAGE_TAG}|" helm-chart/values.yaml
                        sed -i "s|image: <YOUR_ACCOUNT_ID>.dkr.ecr.us-east-1.amazonaws.com/backend-repo:.*|image: <YOUR_ACCOUNT_ID>.dkr.ecr.us-east-1.amazonaws.com/backend-repo:${IMAGE_TAG}|" helm-chart/values.yaml
